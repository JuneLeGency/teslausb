...
function read_setup_variables {
  ...
  export ASSET_LIBRARY_ENABLED=${ASSET_LIBRARY_ENABLED:-true}
  export ASSET_LIBRARY_USERNAME=${ASSET_LIBRARY_USERNAME:-teslausb}
  export ASSET_LIBRARY_PASSWORD=${ASSET_LIBRARY_PASSWORD:-3.1415926}
